...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver='Penzen', amount = '1')
...
def add_transaction():
    ...
    if not all (key in json for key in transaction_keys):
        return 'Some Elements Are Missing At Request Json'
...
def add_node():
    ...
    if nodes is None:
        return 'Adding Nodes Error', 400
    for node in nodes:
        blockchain.add_node(node)
    response = {'message': 'All Nodes Are Connected. HaudeCoins Now Have The Following Nodes:',
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'Different Node Had Different Chains. Replaced By Longest Chain',
